...
const oldPosts = [
  ...
  { id: '2d9c446ea0ab', slug: 'create-a-bouncing-message-notification-icon-from-scratch-with-svg-css' },
  { id: 'a4621e17532b', slug: 'ordered-lists-in-html' },
  { id: 'ba6b8daacfae', slug: 'getting-started-with-r-on-windows' },
  { id: '18ee721136f9', slug: 'zero-to-typescript-developer-using-visual-studio-code-on-ubuntu' },
  { id: '588a3c1677af', slug: 'google-style-gauge-charts-using-d3' },
  { id: 'ccf67957d77f', slug: 'data-by-geographic-distance' },
  { id: '4f8fea489f80', slug: 'passing-data-between-classes-components-in-react' },
  { id: 'b9cd549e4686', slug: 'sunrise-block-clock' },
  { id: '95d3490e3a6f', slug: 'what-did-i-learn-this-week-knex-js-bookshelf-js' },
  ...
  { id: '404ee7df4242', slug: 'creating-a-system-tray-icon-to-display-the-current-ether-usd-market-price' },
  ...
  { id: '33301291b6db', slug: 'dealing-with-asynchronous-functions-in-javascript' },
  ...
  { id: 'f29765a771a3', slug: 'getting-started-with-vue-single-file-components' },
  { id: '63837e075f69', slug: 'using-javascript-to-work-with-spreadsheets-part-3-accepting-arguments-reading-files' },
  { id: '92bbc0a45f27', slug: 'using-javascript-to-work-with-spreadsheets-part-4-making-the-cli-more-robust' },
  { id: 'c5ac049568fd', slug: 'using-javascript-to-work-with-spreadsheets-part-5-parsing-xlsx-files' },
  { id: 'acee318b6759', slug: 'reverse-proxying-node-js-apps-on-windows-with-iis' },
  { id: '3fb2a99b7b03', slug: 'backbone-js' },
  { id: 'ebcfe913dce8', slug: 'web-fonts' },
  { id: '1d31cb14b564', slug: 'increasingly-higher-level-hello-world-with-node' },
  { id: '5e39eec29c78', slug: 'a-recent-technical-challenge-i-experienced-with-pc-hardware' },
  { id: 'b2857451f505', slug: 'building-upon-javascript-with-typescript' },
  { id: '8975e4cec9f8', slug: 'should-you-name-variables-based-on-their-content-or-their-purpose' },
  ...
  { id: '28af49535313', slug: 'enable-file-and-printer-sharing-across-subnets' },
  { id: '7490fa937bde', slug: 'increase-concurrent-connections-in-windows-server-2000' },
  ...
  { id: '18b2a7febd8a', slug: 'recreate-the-google-loading-animation-using-only-css' },
  { id: '15ce4a9fa856', slug: 'updating-dynamic-data-in-d3' },
  { id: '16ef95a9e444', slug: 'getting-browser-width-height' },
  { id: '76f374e9e608', slug: 'what-considerations-do-i-make-while-building-a-web-application-or-site' },
  { id: 'ef1f5467bae9', slug: 'welcome-to-the-redesigned-blog' },
  { id: '40e9b0a7a41a', slug: 'simple-jquery' },
  { id: 'e305f2c951da', slug: 'creating-a-node-js-proxy-to-secure-your-third-party-api-key' },
  { id: 'd8fa0118ee48', slug: 'removing-conficker-downadup' },
  { id: 'caeb96bef7e8', slug: 'using-mssql-with-classic-asp' },
  { id: 'e212e9589679', slug: 'fireflies-with-canvas-and-requestanimationframe' },
  ...
  { id: '34be581ddb0', slug: 'redux-by-example-combined-reducer-with-action-creators' },
  { id: '65ebe7b552bd', slug: 'link-directly-to-googles-i-m-feeling-lucky-feature' },
  { id: '2b9359c68187', slug: 'fake-identity' },
  { id: '67c960a0fcd3', slug: 'i-started-naming-all-my-anonymous-functions-and-you-should-too' },
  { id: '7c2a7c144308', slug: 'responsive-buttons-with-bootstrap' },
  { id: '7843670c6022', slug: 'creating-a-front-end-for-working-with-your-api-proxy' },
  { id: '25142062abf0', slug: 'using-grunt-with-travis-ci' },
  { id: '77406e8ec66b', slug: 'boilerplate-classic-asp-page' },
  { id: '5bc058828241', slug: 'access-the-browsers-query-string-as-a-javascript-object' },
  { id: 'e720256edcee', slug: 'integrating-multiple-stylesheets-in-a-single-site' },
  ...
  { id: '972a2bf69d71', slug: 'why-it-is-better-to-serve-site-assets-from-multiple-domains' },
  { id: '846ebdf11c4e', slug: 'stacked-bar-chart-with-chart-js' },
  { id: '3936728c8bd', slug: 'sql-query-for-counting-records-per-day' },
  { id: 'a68c89facb37', slug: 'a-small-function-to-convert-a-list-of-id-strings-into-a-dictionary-of-jquery-objects' },
  { id: '56eb2c9f371b', slug: 'add-localstorage-to-your-vue-app-in-2-lines-of-code' },
  { id: '2310f1b151d4', slug: 'vue-svg' },
  { id: 'a57cf642b84a', slug: 'building-json2table-turn-json-into-an-html-table' },
  ...
  { id: 'aa3ab75bcc1c', slug: 'setting-up-eslint-on-vs-code-with-javascript-standard-style' },
  { id: 'fdb236afdf82', slug: 'what-if-a-project-uses-tabs-and-you-use-spaces' },
  { id: 'ffd5e158c58a', slug: 'shorten-functions-with-es6-features' },
  { id: 'faf2eb89369e', slug: 'rapid-prototyping-with-css-keyword-colors' },
  { id: 'c0d0f379854f', slug: 'the-importance-of-standards-and-standards-bodies-in-web-development' },
  { id: '5f6c81797d44', slug: '3-ways-a-front-end-developer-can-reduce-page-load' },
  ...
  { id: '4842a41420fe', slug: 'responsive-grid-in-2-minutes-with-css-grid-layout' },
  { id: '2ebd4b29ad30', slug: 'delaying-foreach-iterations' },
  { id: '7a90aca05f1f', slug: 'build-deploy-serverless-functions-in-5-minutes' },
  { id: 'f096e7bcaf7', slug: 'combine-multiple-powershell-commands-into-one' },
  { id: '98ccc40e376b', slug: 'introducing-csval-an-open-source-csv-data-validator' },
  { id: '6eb78a535ba6', slug: 'setting-up-eslint-on-vs-code-with-airbnb-javascript-style-guide' },
  { id: '9074c6befb10', slug: 'using-javascript-to-work-with-spreadsheets-part-1-the-shape-of-the-data' },
  { id: '84e0f410210a', slug: 'using-javascript-to-work-with-spreadsheets-part-2-setting-up-the-workspace' },
  { id: '64008ffc2013', slug: 'excel-formula-to-scale-data-from-0-to-1' },
  { id: '720f365dcb16', slug: 'some-ways-to-align-the-last-row-in-a-flexbox-grid' }
];
