...
1. Click the **Fork** button. This creates a copy of the repository on _your_ account.
...
1. Checkout the latest commits from your forked project: `git pull origin master`. This step is important to make sure you're working with the latest code from _your_ forked project.
