...
`Number.isInteger()` will work in most modern browsers _except_ Internet Explorer. For more information, check out the compatibility table for [ES6 Number](http://caniuse.com/#feat=es6-number). If you need to support Internet Explorer, you can use this handy function:
...
[See a demo of this function in action.](https://codepen.io/travishorn/pen/bZKyGP)

Cover photo by [Don DeBold](https://www.flickr.com/photos/ddebold/) under [CC BY 2.0](https://creativecommons.org/licenses/by/2.0/).
