...
tags: ["mysql", "databases", "mariadb", "replication", "galera-cluster"]
...
3. **ISO Image:** Select the latest Debian ISO image. You can download it from [https://debian.org](https://debian.org)
...
3. Apply the changes by restarting the networking service on all nodes: `systemctl restart networking`
...
Cover photo by [BoliviaInteligente](https://unsplash.com/@boliviainteligente?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/photos/a-colorful-background-with-a-wavy-design-mRWaf6G61qg?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText).