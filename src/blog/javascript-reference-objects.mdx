...
var data1 = new TestData("Central School District", "Lincoln Elementary", 2011);
...
var lincoln = new School("Lincoln", "Elementary");

var data1 = new TestData("Central School District", lincoln, 2011);
