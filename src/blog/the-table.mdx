...
place).](./images/PGj0ssxV3.webp)*Inconsistent decimal places make comparisons
harder*
...
How about a total row? It doesn't *completely* make sense in this case (MLB
...
with total wins, losses, and percent](./images/_N8JPhiUn.webp)*The last row
contains totals for the entire league*
