...
But coding allows us to create systems for inputting this data and generating reports on the fly. If I had an API to pull this data, I could easily code up a chart in D3 like in [this example I just coded up](https://codepen.io/travishorn/pen/qZNMjP).

With the chart coded this way, it is very easy to import and manipulate the data. The endless possibilities are what is excites me about coding.
