...
We need a way to navigate our directory structures without `ls`-ing every single directory. That's where `find` comes in.
...
Cover photo by [Matt Str](https://unsplash.com/@matt039_yt) on [Unsplash](https://unsplash.com/photos/abstract-blue-topographic-map-with-glowing-lines-L5BTvO8eEyQ).
