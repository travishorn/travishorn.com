...
To follow along, you'll need [Node.js](https://nodejs.org) and version 3 of the
[Vue CLI](https://cli.vuejs.org/).

To install Node.js, go to [the homepage](https://nodejs.org) and find your
download.
...
used](https://github.com/travishorn/photo-gallery/raw/master/photo-gallery-images.zip).
...
column. The width is 100% so it always takes up the whole column (and *only* the
