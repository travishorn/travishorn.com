...
![A chart with three buttons to add, modify, and remove data points. (random
data is used here)](./images/rfVON-MrMt.webp)
...
![The same chart, with the additon of another dot around
25,40.](./images/z_ZUx4R02.webp)
...
![The same chart, many new dots, some outside the original age and weight
boundaries. The axes have automatically adjusted to go up to 70 (x) and 160
(y).](./images/yihYiZ0yK.webp)
