...
datePublished: 2020-03-09T11:01:01+00:00
...
![](/images/wOYFLO1cV.webp)

Follow along and we’ll build something like this:

![A chart with three buttons to add, modify, and remove data points. (random data is used here)](/images/rfVON-MrMt.webp)*A chart with three buttons to add, modify, and remove data points. (random data is used here)*
...
![The visual result of the code we’ve written so far.](/images/C-tcojSY8.webp)*The visual result of the code we’ve written so far.*
...
![The chart now has four data points because I clicked “Add whale”](/images/z_ZUx4R02.webp)*The chart now has four data points because I clicked “Add whale”*
...
![The chart now has data points outside the original age and weight boundaries](/images/yihYiZ0yK.webp)*The chart now has data points outside the original age and weight boundaries*
