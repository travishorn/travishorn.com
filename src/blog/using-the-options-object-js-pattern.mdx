...
What if I want to set *even more* attributes for the circle? I *could* keep
...
Notice the *order* of the arguments no longer matters. The function finds the
correct argument by *name*.
...
operators](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Logical_Operators#Logical_OR)
...
going to use [its `random` function](https://lodash.com/docs/4.17.10#random) on
...
visible](./images/QOt9qH8fW.webp)*A circle of random shape and color*
...
function](https://lodash.com/docs/4.17.10#sample).
...
![One hundred random circles](./images/nuXtdsD69.webp)*One hundred random
circles*

To what other shapes might you apply this pattern? To what other *tasks or
functions* might you apply this pattern? It can be used anywhere you create a
