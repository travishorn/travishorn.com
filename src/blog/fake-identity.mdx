...
_Generate random identity objects including name, address, etc. This may be useful if you are trying to fill your application with random personal data._
...
_User icon by [OmmoZoubayr](http://www.ommozoubayr.esy.es/)_
