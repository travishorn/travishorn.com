---
title: "The <table>"
datePublished: 2017-11-30T22:01:09+00:00
cover: /images/9MKjzc94r.jpeg
...
![A &lt;table&gt; as it appears in Chrome using Normalize.css](/images/1_129mjcQNzC7q5cHGeUtE1g.webp)*A &lt;table&gt; as it appears in Chrome using [Normalize.css](https://necolas.github.io/normalize.css/)*
...
![With just a little bit of spacing, the table looks way better already](/images/dHiAkpFM_.webp)*With just a little bit of spacing, the table looks way better already*
...
![Adding horizontal lines makes it easier to scan across a row](/images/S1QTQSdul.webp)*Adding horizontal lines makes it easier to scan across a row*
...
![All cells are aligned to the left edge](/images/HTME6iGvZ.webp)*All cells are aligned to the left edge*
...
![Numbers can be more easily compared when their places are aligned](/images/HssxChFBD.webp)*Numbers can be more easily compared when their places are aligned*
...
![Inconsistent decimal places make comparisons harder](/images/PGj0ssxV3.webp)*Inconsistent decimal places make comparisons harder*
...
![Places stay aligned with a monospace font](/images/EtOYEVPJU.webp)*Places stay aligned with a monospace font*
...
![Table using Roboto and Roboto Mono](/images/xyB84S930.webp)*Table using Roboto and Roboto Mono*
...
![Table caption at the bottom](/images/qlqEybrCL.webp)*Table caption at the bottom*
...
![The caption can be styled to give a more title-like feel](/images/l7WZPLUnR.webp)*The caption can be styled to give a more title-like feel*
...
![The text cursor](/images/WkZ4l8IsU.webp)*The text cursor*
...
![The default cursor](/images/NZQrDMlsB.webp)*The default cursor*
...
![The last row contains totals for the entire league](/images/_N8JPhiUn.webp)*The last row contains totals for the entire league*
...
![The **Pct** text is colored based on its value](/images/dFdx6S2A9.webp)*The **Pct** text is colored based on its value*
...
![The light text is easier to read with a darker outline](/images/PoP9sL_3k.webp)*The light text is easier to read with a darker outline*
