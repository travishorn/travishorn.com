...
Using packaged modules like that in Node is great. But what about the browser? Like everything else I've mentioned, there are _many_ ways to get this done. One simple option is **browserify**.
