...
*The brackets \[\] are only there for demonstration and should not be included
in your file.*
...
In the **node\_exporter** section, copy the listed URL. It will be labeled
something like **node\_exporter-1.5.0.linux-amd64.tar.gz**.
