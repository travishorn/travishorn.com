...
The app is done! [Check out the finished product.](https://codepen.io/travishorn/pen/YVQEKJ). Check the boxes and watch the binary representation change. Change the binary and watch the boxes check/uncheck themselves.
