...
![Diagram illustrating parallax: two viewpoints (A and B) look at a star-shaped object against a red-white-blue background, and the object appears over different background colors depending on the viewpoint.](./images/1_FgaE6dpDUhSgv7eQltSQKw.webp)_["Parallax Example" by Booyabazooka. Licensed under CC BY-SA 3.0 via Commons](https://commons.wikimedia.org/wiki/File:Parallax_Example.svg#/media/File:Parallax_Example.svg)_
