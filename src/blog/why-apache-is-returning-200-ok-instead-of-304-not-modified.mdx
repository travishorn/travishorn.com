...
Then I remembered I had enabled compression (mod\_deflate) using
...
the underlying file and compares it to the client's header *before* it applies
compression.
...
Because the suffix is added *after* the comparison, the client's ETag will never
