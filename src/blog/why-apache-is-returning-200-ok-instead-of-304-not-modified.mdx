...
configurations often prioritize the **ETag** because it is considered a more
accurate validator than a simple timestamp.
...
Disabling a standard HTTP feature like ETags might feel like a drastic measure,
but for most static sites, it is actually a safe and often recommended
optimization.
