...
While this _will_ work, it is incorrect on a semantic level. Tables should only be used for tabular data. Think of the real purpose of a table: to show data in columns and rows with labels. Our use-case does not fit.
