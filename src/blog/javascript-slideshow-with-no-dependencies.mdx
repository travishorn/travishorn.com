---
cover: ./images/9z8GE4F38.webp
datePublished: 2016-08-08 22:01:03+00:00
tags:
- css
- html
- javascript
...
Even with an empty **slideshow.js**, the images are displayed in a neat column for viewing. Now let's add a little JavaScript.
...
[See a demo of the slideshow we just created.](https://codepen.io/travishorn/pen/rLvQEE)
...
Cover photo by [Nathan Anderson](https://unsplash.com/@nathananderson).